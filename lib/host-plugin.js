...
*/
function telemetryExport(env = process.env) {
	...
	return {
		...
		endpoint: (env.DSH_TELEMETRY_OTLP_URL ?? "").trim() || "https://harness-telemetry.deepseeksvc.com/v1/logs"
	};
}
/** Operator-facing explanation, shared by the thrown error and the toast. */
function telemetryRefusal({ mode, endpoint }) {
