window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0relay-css-module:/Users/boboyang/work/Relay/.tmp/relay-dsh-plugin-claude/src/client/ClaudeActivityView.module.css.mjs
		const css = ".QItvba_activity{width:min(100%,960px);color:var(--dsw-alias-label-secondary)}.QItvba_summary{min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;align-items:center;gap:8px;font-size:13px;display:flex}.QItvba_summary :first-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.QItvba_detail{border-left:1px solid var(--dsw-alias-border-l2);margin:4px 0 8px 28px;padding-left:12px;overflow:hidden}.QItvba_detail pre{max-height:320px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;word-break:break-word;margin:0 0 8px;overflow:auto}.QItvba_provenance{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;margin-bottom:8px;font-size:12px;line-height:18px;overflow:hidden}";
		...
		var ClaudeActivityView_module_css_default = {
			"summary": "QItvba_summary",
			"activity": "QItvba_activity",
			"detail": "QItvba_detail",
			"provenance": "QItvba_provenance"
		};
		//#endregion
